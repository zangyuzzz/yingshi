...
class Spider(Spider):
    ...
    def init(self, extend=''):
        ...
        try:
            ...
            if 'data' in response and response['data']:
                ...
                print(f"init成功: userid={self.userid}, token={token[:20]}...")
            else:
                print(f"init响应数据异常: {response}")
        except Exception as e:
            print(f"init失败: {e}")
            self.userid = "1"
            self.headers['token'] = ""
        ...
        for cate in result['class']:
            ...
            filters[tid] = [
                ...
                {"key": "year", "name": "年份", "value": [
                    ...
                    {"n": "2020", "v": "2020"}, {"n": "2019", "v": "2019"}, {"n": "更早", "v": "2018"}
                ]},
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                for future in concurrent.futures.as_completed(future_to_id):
                    try:
                        ...
                        if 'data' in response and response['data'] and 'records' in response['data']:
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        try:
            ...
            print(f"categoryContent失败: {e}")
            videos = []
        return {'list': videos, 'page': int(pg), 'pagecount': 9999, 'limit': 40, 'total': 999999}
